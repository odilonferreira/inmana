...
# Configuration that makes the keys use uuids
...
config :inmana, InmanaWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "JQqgYz/K7ESceQESQmChlNiHW0w4CcMz7XkTCPYVnADrOjzq8565Uv2YoOOI+vZE",
  render_errors: [view: InmanaWeb.ErrorView, accepts: ~w(json), layout: false],
  pubsub_server: Inmana.PubSub,
  live_view: [signing_salt: "iCWqjNCr"]
